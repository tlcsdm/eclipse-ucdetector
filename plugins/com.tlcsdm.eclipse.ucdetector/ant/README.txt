...
* Eclipse Version: >= 4.2
* com.tlcsdm.eclipse.ucdetector_x.y.z.jar
...
** Put com.tlcsdm.eclipse.ucdetector_x.y.z.jar in      : ucdetector-headless/eclipse/plugins (dropins may not work)
** Unzip com.tlcsdm.eclipse.ucdetector_x.y.z.zip/ant to: ucdetector-headless/ant
...
== Troubleshooting ==
* Check
** Last version of this file: http://svn.code.sf.net/p/ucdetector/code/trunk/com.tlcsdm.eclipse.ucdetector/ant/README.txt
** ECLIPSE_HOME/configuration/*.log
** ucdetector-headless/workspace/.metadata/.log
* UCDetector must be installed in: ${ECLIPSE_HOME}/plugins/com.tlcsdm.eclipse.ucdetector_x.y.z.jar
