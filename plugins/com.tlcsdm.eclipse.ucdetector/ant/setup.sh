...
UCDETECTOR=com.tlcsdm.eclipse.ucdetector_$UCDETECTOR_VERSION.jar
UCDETECTOR_SOURCE=com.tlcsdm.eclipse.ucdetector.source_$UCDETECTOR_VERSION.zip
...
mkdir -p workspace/com.tlcsdm.eclipse.ucdetector
# ---------------------------------------------------------------------
# Adapt next lines: Put your eclipse projects in workspace folders
# ---------------------------------------------------------------------
# override, quiet
unzip -o -q downloads/$UCDETECTOR_SOURCE -d workspace/com.tlcsdm.eclipse.ucdetector
# ---------------------------------------------------------------------
...
cp -r workspace/com.tlcsdm.eclipse.ucdetector/ant .
