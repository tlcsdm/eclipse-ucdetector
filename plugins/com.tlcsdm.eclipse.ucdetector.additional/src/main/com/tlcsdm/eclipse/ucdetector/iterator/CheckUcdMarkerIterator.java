 ...
 * To 'test' UCDetector
 * <ul>
 * <li>Run UCDetector in directory /com.tlcsdm.eclipse.ucdetector.example/example</li>
 * <li>Run this class (pop up menu 'Find bad Markers') in directory /com.tlcsdm.eclipse.ucdetector.example/example</li>
