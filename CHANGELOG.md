...
New features:
 ...
 - New extension point 'com.tlcsdm.eclipse.ucdetector.reports' to create custom report using xslt or java
...
Bugfixes:
 ...
 - Add example plugin to write your own detection: com.tlcsdm.eclipse.ucdetector.additional
